...
class User(models.Model):
    ...
    areas_para_solicitar = models.ManyToManyField(Area,through="UserSolicita",related_name="users_que_solicitan")
    areas_para_autorizar = models.ManyToManyField(Area,through="UserAutoriza",related_name="users_que_autorizan")
    areas_para_ejecutar = models.ManyToManyField(Area,through="UserEjecuta",related_name="users_que_ejecutan")
...
class UserSolicita(models.Model):
    tipo_mov = models.ForeignKey(TipoMov,related_name="areausers_que_solicitan",on_delete=models.CASCADE)
    user = models.ForeignKey(User,related_name="areastipomov_donde_solicita",on_delete=models.CASCADE)
    area = models.ForeignKey(Area,related_name="userstipomov_que_solicitan",on_delete=models.CASCADE)

class UserAutoriza(models.Model):
    tipo_mov = models.ForeignKey(TipoMov,related_name="areausers_que_autorizan",on_delete=models.CASCADE)
    user = models.ForeignKey(User,related_name="areastipomov_donde_autoriza",on_delete=models.CASCADE)
    area = models.ForeignKey(Area,related_name="userstipomov_que_autorizan",on_delete=models.CASCADE)

class UserEjecuta(models.Model):
    tipo_mov = models.ForeignKey(TipoMov,related_name="areausers_que_ejecutan",on_delete=models.CASCADE)
    user = models.ForeignKey(User,related_name="areastipomov_donde_ejecuta",on_delete=models.CASCADE)
    area = models.ForeignKey(Area,related_name="userstipomov_que_ejecutan",on_delete=models.CASCADE)
