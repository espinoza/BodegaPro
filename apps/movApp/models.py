...
class MovEncabezado(models.Model):
    ...
    #def monto(self):
    #    monto = 0
    #    for fila_det in self.rdc_detalle.all():
    #        monto += fila_det.monto
    #    return  monto
...
class MovEstado(models.Model):
    mov_encabezado = models.ForeignKey(MovEncabezado,related_name='mov_estado',on_delete=models.CASCADE)
