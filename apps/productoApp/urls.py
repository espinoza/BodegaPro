...
urlpatterns = [
    ...
    path('item/activar',views.toggleItemProducto,name ='toggleitemprodactivar'), #AJAX
    path('item/desactivar',views.toggleItemProducto,name='toggleitemproddesactivar'), #AJAX
