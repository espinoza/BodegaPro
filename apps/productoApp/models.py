...
class Producto(models.Model):
    ...
    unidad_medida = ForeignKey(UnidadMedida,related_name="productos",on_delete=models.PROTECT)
    familia = ForeignKey(Familia,related_name="productos",on_delete=models.PROTECT)
